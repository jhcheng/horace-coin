...
class TxTest {
    ...
    @SneakyThrows
    @Test
    void test_parse_legacy_version() {
        ...
        Tx tx = Tx.parse(ByteBuffer.wrap(HexFormat.of().parseHex(raw_tx)));
        assertEquals(1, tx.getVersion());
    }

    @SneakyThrows
    @Test
    void test_parse_legacy_inputs() {
        String raw_tx = "";
        Tx tx = Tx.parse(ByteBuffer.wrap(HexFormat.of().parseHex(raw_tx)));
    ...
    @SneakyThrows
    @Test
    void test_parse_legacy_outputs() {
        String raw_tx = "";
        Tx tx = Tx.parse(ByteBuffer.wrap(HexFormat.of().parseHex(raw_tx)));
    ...
    @SneakyThrows
    @Test
    void test_parse_legacy_outputs_02() {
    ...
    @SneakyThrows
    @Test
    void test_parse_legacy_locktime() {
        String raw_tx = "";
        Tx tx = Tx.parse(ByteBuffer.wrap(HexFormat.of().parseHex(raw_tx)));
    ...
    void test_sign_input() {
        ...
        Tx tx = Tx.parse(ByteBuffer.wrap(HexFormat.of().parseHex("010000000199a24308080ab26e6fb65c4eccfadf76749bb5bfa8cb08f291320b3c21e56f0d0d00000000ffffffff02408af701000000001976a914d52ad7ca9b3d096a38e752c2018e6fbc40cdf26f88ac80969800000000001976a914507b27411ccf7f16f10297de6cef3f291623eddf88ac00000000")), true);
    ...
    void test_redeem_script() {
        ...
        String hex_redeem_script = "475221022626e955ea6ea6d98850c994f9107b036b1334f18ca88" +
                ...
                "bdbd4bb7152ae";
        Tx tx_obj = Tx.parse(ByteBuffer.wrap(hexFormat.parseHex(hex_tx)));
        Script redeem_script = Script.parse(ByteBuffer.wrap(hexFormat.parseHex(hex_redeem_script)));
